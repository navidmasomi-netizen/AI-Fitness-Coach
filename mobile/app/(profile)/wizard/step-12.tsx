...
const stepTwelveHero = require("../../../assets/images/onboarding/onboarding-step-12-eating-habits-hero.png");
...
export default function WizardStepTwelveScreen() {
  ...
  const onContinue = async () => {
    if (!nutritionHabits || isSaving) return;
  ...
  return (
    <View style={styles.root}>
      <ImageBackground source={stepTwelveHero} resizeMode="cover" style={styles.background} imageStyle={styles.heroImage} accessible={false}>
            ...
            <View style={styles.content}>
              <View style={styles.topContent}>
                ...
                <View style={styles.questionBlock}>
                  ...
                  <Text accessibilityRole="header" style={styles.questionTitle}>
                    ...
                    <Text style={styles.questionAccent}>your eating habits?</Text>
                  </Text>
                  <Text style={styles.coachingCopy}>
                    This gives us useful nutrition context for future coaching — no calorie tracking required.
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.bottomContent}>
                  ...
                  {NUTRITION_OPTIONS.map((option) => {
                    ...
                    return (
                      <Pressable
                        key={option}
                        accessibilityRole="button"
                        accessibilityLabel={NUTRITION_HABITS_LABELS[option]}
                ...
                <View style={styles.actionRow}>
                  <Pressable
                    accessibilityRole="button"
                    accessibilityLabel="Go back to the recovery question"
                    hitSlop={8}
                    onPress={() => router.replace("/(profile)/wizard/step-11")}
                  ...
                  <Pressable
                    ...
                    accessibilityState={{ disabled: !nutritionHabits || isSaving, busy: isSaving }}
                    disabled={!nutritionHabits || isSaving}
                    onPress={onContinue}
                    style={({ pressed }) => [
                      styles.continueButton,
                      (!nutritionHabits || isSaving) && styles.continueButtonDisabled,
                      pressed && !!nutritionHabits && !isSaving && styles.continueButtonPressed,
                    ]}
                  >
                    <Text
                      style={[
                        styles.continueLabel,
                        (!nutritionHabits || isSaving) && styles.continueLabelDisabled,
                      ]}
                    >
                    ...
                    <Feather
                      name="arrow-right"
                      size={20}
                      color={!nutritionHabits || isSaving ? colors.disabledText : colors.textPrimary}
                    />
                  </Pressable>
                </View>
...
const styles = StyleSheet.create({
  ...
  heroImage: { top: -80 },
  baseTone: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(1, 5, 12, 0.12)" },
  ...
  topShade: {
    ...
    left: 0,
    height: "22%",
    backgroundColor: "rgba(1, 5, 12, 0.06)",
  },
  bottomShade: {
    position: "absolute",
    right: 0,
    ...
    left: 0,
    height: "58%",
    backgroundColor: "rgba(1, 5, 12, 0.74)",
  },
  safeArea: { flex: 1 },
  scroll: { flex: 1 },
