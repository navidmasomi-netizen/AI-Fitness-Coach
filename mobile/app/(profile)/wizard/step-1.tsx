...
const stepOneHero = require("../../../assets/images/onboarding/onboarding-step-1-goal-hero.png");

const GOAL_OPTIONS = [
  {
    value: "hypertrophy",
    title: "Muscle Growth",
    description: "Build size and\nmuscle mass",
    icon: "barbell-outline",
  },
  {
    value: "strength",
    title: "Strength",
    description: "Get stronger and\nlift heavier",
    icon: "arm-flex-outline",
  },
  {
    value: "fat_loss",
    title: "Fat Loss",
    description: "Reduce body fat and\nget leaner",
    icon: "flame-outline",
  },
  {
    value: "recomposition",
    title: "Body Recomposition",
    description: "Build muscle while\nlosing fat",
    icon: "sync-outline",
  },
] as const;
            ...
            <View style={styles.content}>
              <View style={styles.topContent}>
                ...
                <View style={styles.questionBlock}>
                  ...
                  <Text accessibilityRole="header" style={styles.questionTitle}>
                    What&apos;s your{"\n"}
                    <Text style={styles.questionAccent}>primary goal?</Text>
                  </Text>
                  <Text style={styles.coachingCopy}>This helps me prioritize your training plan.</Text>
                </View>
              ...
              <View style={styles.bottomContent}>
                ...
                <Pressable
                  ...
                  accessibilityState={{ disabled: goal === null || isSaving, busy: isSaving }}
                  disabled={goal === null || isSaving}
                  onPress={onContinue}
                  style={({ pressed }) => [
                    styles.continueButton,
                    (goal === null || isSaving) && styles.continueButtonDisabled,
                    pressed && goal !== null && !isSaving && styles.continueButtonPressed,
                  ]}
                >
                  <Text style={[styles.continueLabel, (goal === null || isSaving) && styles.continueLabelDisabled]}>
                    {isSaving ? "Saving..." : "Continue"}
                  </Text>
                  <Feather name="arrow-right" size={20} color={goal === null || isSaving ? colors.disabledText : colors.textPrimary} />
                </Pressable>
