...
const stepFifteenBBackground = require("../../../assets/images/onboarding/onboarding-step-15b-other-supplements-background.png");
            ...
            >
              <View style={styles.content}>
                ...
                <View style={styles.topContent}>
                  ...
                  <View style={styles.questionBlock}>
                    ...
                    <Text accessibilityRole="header" style={styles.questionTitle}>
                      What other{"\n"}
                      <Text style={styles.questionAccent}>supplements</Text>
                      {"\n"}do you use?
                    </Text>
                    <Text style={styles.coachingCopy}>Add any supplements not listed earlier.</Text>
                  </View>
                </View>
                ...
                <View style={styles.inputPanel}>
                  ...
                  <TextInput
                    accessibilityLabel="Other supplements you use"
                    ...
                    multiline
                    placeholder="Type other supplements here..."
                ...
                <View style={styles.bottomContent}>
                  ...
                  <View style={styles.actionRow}>
                    <Pressable
                      accessibilityRole="button"
                      accessibilityLabel="Go back to the supplements selection"
                      hitSlop={8}
                      onPress={() => router.replace("/(profile)/wizard/step-15")}
