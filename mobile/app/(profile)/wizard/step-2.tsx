...
const stepTwoHero = require("../../../assets/images/onboarding/onboarding-step-2-level-hero.png");
...
const TRAINING_LEVEL_OPTIONS = [
  ...
  },
  {
    value: "intermediate",
    title: "Intermediate",
    description: "Training consistently and\nready to progress",
    icon: "trending-up",
  },
  {
    value: "advanced",
    title: "Advanced",
    description: "Experienced with structured,\nhigh-level training",
    icon: "medal-outline",
  },
] as const;
...
export default function WizardStepTwoScreen() {
  ...
  const onContinue = async () => {
    ...
    if (didSave) {
      router.push("/(profile)/wizard/step-3");
    }
  };
            ...
            <View style={styles.content}>
              <View style={styles.topContent}>
                ...
                <View style={styles.questionBlock}>
                  <Text style={styles.chapterLabel}>GOALS &amp; LEVEL</Text>
                  <Text accessibilityRole="header" style={styles.questionTitle}>
                    What’s your{"\n"}
                    <Text style={styles.questionAccent}>training level?</Text>
                  </Text>
                  <Text style={styles.coachingCopy}>
                    This helps me match the training intensity to your experience.
                  </Text>
                </View>

                <View style={styles.optionList}>
                  {TRAINING_LEVEL_OPTIONS.map((option) => {
                    const isSelected = trainingLevel === option.value;
                    return (
                      <Pressable
                        key={option.value}
              ...
              <View style={styles.bottomContent}>
                ...
                <View style={styles.actionRow}>
                  ...
                  <Pressable
                    ...
                    accessibilityState={{ disabled: trainingLevel === null || isSaving, busy: isSaving }}
                    disabled={trainingLevel === null || isSaving}
                    onPress={onContinue}
                    style={({ pressed }) => [
                      styles.continueButton,
                      (trainingLevel === null || isSaving) && styles.continueButtonDisabled,
                      pressed && trainingLevel !== null && !isSaving && styles.continueButtonPressed,
                    ]}
                  >
                    <Text style={[styles.continueLabel, (trainingLevel === null || isSaving) && styles.continueLabelDisabled]}>
                      {isSaving ? "Saving..." : "Continue"}
                    </Text>
                    <Feather
                      name="arrow-right"
                      size={20}
                      color={trainingLevel === null || isSaving ? colors.disabledText : colors.textPrimary}
                    />
                  </Pressable>
                </View>
...
const styles = StyleSheet.create({
  ...
  baseTone: {
    ...
    backgroundColor: "rgba(1, 5, 12, 0.26)",
  },
